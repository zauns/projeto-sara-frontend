  ...
  return (
    <Sheet>
      ...
      <SheetTrigger asChild>
        <Button className="text-black p-2 rounded-md hover:bg-gray-100" aria-label="Abrir menu" type="button">
      ...
      <SheetContent className="w-[300px] bg-white" side="left">
        ...
        <nav className="mt-8 flex flex-col gap-2">
          ...
          <SidebarLink href="#" icon={<Briefcase className="h-5 w-5" />}>
            Vagas
          </SidebarLink>
          ...
          <SidebarLink href="#" icon={<Settings className="h-5 w-5" />}>
            Configurações {/*fiz esse aqui tambem mas se couber no escopo necessário podemos só remover*/}
          </SidebarLink>

          {/* Divisor */}
          <hr className="my-4 border-t border-gray-200" />

          <SidebarLink href="#" icon={<LogOut className="h-5 w-5" />}>
            Sair
          </SidebarLink>
        </nav>
      </SheetContent>
